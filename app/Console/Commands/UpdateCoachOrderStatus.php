...
class UpdateCoachOrderStatus extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:coach-orders';
    ...
    public function __construct()
    {
        ...
        $this->sheet_detail = config('sheet.sheets_detail.order.coach');
        parent::__construct();
    }
    public function handle()
    {
        try {
            ...
            foreach($orders as $order){
                $orderId = data_get($order, config('sheet.defaultHeader.order.coach')[0]);
